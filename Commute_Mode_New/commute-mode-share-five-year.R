...
COMMUTE_CITY = paste0("http://api.census.gov/data/",ACS_year,"/acs",ACS_product,"?get=NAME,B08301_001E,B08301_002E,B08301_003E,B08301_004E,B08301_010E,B08301_019E,B08301_018E,B08301_016E,B08301_017E,B08301_020E,B08301_021E&in=state:",state,"&for=place:",city,"&key=",key)


#Now Work

WORK_COMMUTE_CITY = paste0("http://api.census.gov/data/",ACS_year,"/acs",ACS_product,"?get=NAME,B08601_001E,B08601_002E,B08601_003E,B08601_004E,B08601_010E,B08601_019E,B08601_018E,B08601_016E,B08601_017E,B08601_020E,B08601_021E&in=state:",state,"&for=place:",city,"&key=",key)
...
city_commute_residence <- f.rawdata(COMMUTE_CITY)
...
city_residence_share <- city_residence_mode %>% mutate(
...
city_residence_share_melt <- melt(city_residence_share, 
              id.vars=c("Id", "Id2", "Residence_Geo","Year", "Workers_Est", "Source"),
              variable.name="Transport_Mode",
              value.name="Share"
              )

city_residence_share_melt$Transport_Mode_Label <- values[match(city_residence_share_melt$Transport_Mode, index)]

city_residence_share_melt <- city_residence_share_melt[c(1,2,3,4,5,7,9,8,6)]
 
#Now tracts

COMMUTE_TRACT_RESIDENCE = paste0("http://api.census.gov/data/",ACS_year,"/acs",ACS_product,"?get=NAME,B08301_001E,B08301_002E,B08301_003E,B08301_004E,B08301_010E,B08301_019E,B08301_018E,B08301_016E,B08301_017E,B08301_020E,B08301_021E&in=state:",state,"+county:",county,"&for=tract:*&key=",key)

tract_commute_residence <- f.rawdata(COMMUTE_TRACT_RESIDENCE)
...
# Area below is all draft; do not use without fixing
...
ALAMEDA_COMMUTE_TRACTS = paste0("http://api.census.gov/data/2014/acs5?get=NAME,B08301_001E,B08301_002E,B08301_003E,B08301_004E,B08301_010E,B08301_019E,B08301_018E,B08301_016E,B08301_017E,B08301_020E,B08301_021E&in=state:06+county:001&for=tract:",Alameda_residence_timesub_tracts)
